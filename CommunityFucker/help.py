...
${Fore.GREEN}============================== HELP  ==============================
    ...
    if (int(que_ans)==1):
        ...
        To buy proxies go to https://t.me/DareDevilKinng and ask proxy.
        ...
        For more help you can directly contact me on https://t.me/DareDevilKinng
        Or you can report bugs at https://t.me/DareDevilKinng
        ...
        ''')
        help_msg()
        webbrowser.open('http://t.me/DareDevilKinng')
    elif(int(que_ans)==4):
        clearConsole()
